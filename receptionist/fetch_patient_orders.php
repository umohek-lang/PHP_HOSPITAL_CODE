...
// Fetch Drug Chart
$drugChartStmt = $pdo->prepare("SELECT * FROM drug_chart WHERE patient_id = ? ORDER BY chart_id DESC");
$drugChartStmt->execute([$patient_id]);
$drug_chart = $drugChartStmt->fetchAll(PDO::FETCH_ASSOC);
