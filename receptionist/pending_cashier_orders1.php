...
$recordsPerPage = 5; // You can change this to show more or fewer records
...
<head>
    <meta charset="UTF-8">
    <title>Orders Sent to Cashier</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>

<div class="container my-5">
    <h2 class="text-center mb-4">ðŸ§¾ Bill Orders Sent by Doctor</h2>
            ...
            foreach ($orders as $order) {
                echo "<tr>
                        ...
                        <td>
                            ...
                            <a href='../cashier/bill_patient2.php?patient_id={$order['patient_id']}' class='btn btn-sm btn-outline-primary mt-1'>âž• Bill</a>
                           <!-- <a href='../cashier/view_bill.php?patient_id={$order['patient_id']}' class='btn btn-sm btn-outline-success mt-1'>ðŸ§¾ View Bill</a>-->
                        </td>
                      </tr>";
            }
