...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($existing) {
        ...
        if ($stmt->execute([$role_id, $full_name, $email, $phone, $password])) {
            ...
            $generatedPassword = $plain_password;
        } else {
                ...
                <form method="post" class="fade-in" id="registerForm">
                    ...
                    <div class="mb-3">
                        <select name="role_id" class="form-select" required>
                            ...
                            <option value="9">MD</option> <!-- NEW MD Role -->
                        </select>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content rounded-3">
                ...
                <div class="modal-body">
                    <p><strong>Email:</strong> <?= htmlspecialchars($generatedEmail ?? '') ?></p>
                    <p><strong>Your Password:</strong> <?= htmlspecialchars($generatedPassword ?? '') ?></p>
                    <div class="alert alert-warning">Please copy and save your password securely!</div>
                </div>
                <div class="modal-footer">
